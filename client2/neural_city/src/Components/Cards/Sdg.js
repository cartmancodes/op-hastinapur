...
function Sdg() {
    ...
    return (
        <div className='bg-white h-[190px] sm:h-[150px] rounded-sm w-full shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] '>
                ...
                >

                    {
                        headings.map((head, idx) => {
                            return (selectedIdx === idx) ? <div className='text-lg py-2 backdrop-blur-xl backdrop-brightness-100 bg-white'>
                                <p>{head}</p>
                            </div> :
