...
function RightSideBar(props) {
    return (
        <div className='hidden sm:flex flex-col sticky top-20 right-0 rounded-md h-[80vh] items-center shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] w-[27%] ml-[20px] scroll-smooth'>
