...
export default function InsightTable() {
    ...
    const [parameter,setParameter] = useState("ward");
                ...
                <div className='py-4 space-y-2 sm:space-y-0 w-full shadow-lg rounded-t-lg px-2 sm:flex items-center justify-between'>
                    <div className='text-2xl w-[50%] flex items-center font-bold space-x-2'>
                        ...
                        <FormControl sx={{ m: 1, minWidth: 250 }} size="small">
                            <InputLabel id="demo-select-small-label">Division Type</InputLabel>
                            <Select
                                value={parameter}
                                label="Division Type"
                            ...
                            >
                                ...
                                <MenuItem value={"polling booths"}>Polling Booths</MenuItem>
                    ...
                    <Table stickyHeader aria-label="sticky table">
                        ...
                        <TableBody>
                            {rows
                                ...
                                .map((row) => {
                                    return (
                                        <InsightTableRow row={row} columns={columns} />
                                    );
                                })}
                        </TableBody>
                    </Table>
